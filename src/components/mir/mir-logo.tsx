// Mir logo — Apple/SF Symbols-inspired design.
...
export function MirLogo({ className, size = 28, showStatusDot = true }: MirLogoProps) {
  return (
    <svg
...
export function MirLogoLarge({ className, size = 120 }: { className?: string; size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 128 128"
