    ...
    <div className="flex h-full flex-col">
        ...
        {tab === "containers" && (
          <div className="p-3 space-y-1.5">
            {containers.map(c => (
              <div
                key={c.id}
                className="group rounded-xl border border-border/50 mir-card p-3 hover:shadow-md transition-shadow"
              >
                ...
                <div className="flex items-center gap-1 mt-2 pt-2 border-t border-border/30">
                  ...
                  <Button variant="ghost" size="sm"
                    className="h-6 gap-1 text-[11px] mir-press ml-auto opacity-0 group-hover:opacity-100 hover:text-status-error"
      ...
      <Dialog open={!!logsContainer} onOpenChange={(o) => !o && setLogsContainer(null)}>
        <DialogContent className="sm:max-w-3xl max-h-[80vh] flex flex-col">
          ...
          <div className="flex-1 overflow-auto mir-scroll rounded-lg bg-black/30 p-3 font-mono text-[11px]">
            {loadingLogs ? (
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl max-h-[70vh] flex flex-col">
        ...
        <div className="flex-1 overflow-auto mir-scroll rounded-lg bg-black/30 p-3 space-y-2">
        ...
        <div className="flex items-center gap-2 border-t border-border/50 px-3 py-2.5">
          ...
          <input
            ...
            autoFocus
          />
          <Button size="sm" className="h-7 gap-1 text-[12px] mir-press" onClick={run} disabled={loading}>
