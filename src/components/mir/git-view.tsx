...
export function GitView() {
  const { projects, activeProjectId, setActiveProject } = useMir();
    ...
    <div className="flex h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-border/50">
        ...
        <div className="relative">
          ...
          {showProjectPicker && (
            <>
              ...
              <div className="fixed z-[9999] w-64 rounded-lg border border-border/50 mir-frosted shadow-2xl p-1"
                   style={{
        ...
        <div className="ml-auto flex items-center gap-1">
          <Button variant="outline" size="sm" className="h-7 gap-1.5 text-[12px] mir-press" onClick={handlePull} disabled={actionLoading}>
            <ArrowDown className="h-3 w-3" /> Pull
          </Button>
          <Button variant="outline" size="sm" className="h-7 gap-1.5 text-[12px] mir-press" onClick={handlePush} disabled={actionLoading}>
      ...
      <div className="flex-1 overflow-auto mir-scroll">
        ...
        {tab === "terminal" && (
          <div className="flex flex-col h-full">
            <div className="flex-1 overflow-auto mir-scroll p-4 space-y-2">
            ...
            <div className="flex items-center gap-2 border-t border-border/50 px-4 py-2.5 bg-muted/20">
              ...
              <input
                ...
                autoFocus
              />
              <Button size="sm" className="h-7 gap-1 text-[12px] mir-press" onClick={handleTerminalCommand}>
