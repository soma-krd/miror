...
interface DatabaseBrowserProps {
  ...
  defaultPath?: string;  // e.g., the Mir DB path or a service's DB
}
...
export function DatabaseBrowser({ open, onOpenChange, defaultPath }: DatabaseBrowserProps) {
  const [dbPath, setDbPath] = useState(defaultPath ?? "/home/z/my-project/.mir/mir.db");
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-5xl max-h-[85vh] flex flex-col">
        ...
        <div className="flex flex-1 min-h-0 gap-2">
          {/* Tables sidebar */}
          <div className="w-56 shrink-0 border-r border-border overflow-y-auto mir-scroll">
