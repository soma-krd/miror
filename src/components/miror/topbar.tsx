    ...
    <>
      <header className="flex h-11 items-center gap-3 px-4 bg-background/60 backdrop-blur-xl border-b border-border/50">
        ...
        <div className="flex items-center gap-1.5 text-[13px]">
          <span className="text-muted-foreground/60">Miror</span>
        ...
        <button
          ...
          className="relative ml-3 flex h-7 w-full max-w-xs items-center gap-2 rounded-lg bg-muted/50 px-2.5 text-left text-[12px] text-muted-foreground/70 transition-all hover:bg-muted/80 miror-press"
        >
        ...
        {activeProject && projectServices.length > 0 && (
          <div className="flex items-center gap-0.5">
            <Button
              variant="ghost"
              size="sm"
              className="h-7 gap-1.5 text-[12px] font-medium miror-press"
        ...
        <div className="ml-auto flex items-center gap-1">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-7 w-7 text-muted-foreground/70 hover:text-foreground miror-press"
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="ghost" size="icon" className="relative h-7 w-7 text-muted-foreground/70 hover:text-foreground miror-press" aria-label="Notifications">
            ...
            <PopoverContent align="end" className="w-80 p-0 miror-frosted border-border/50">
              ...
              <div className="max-h-80 overflow-y-auto miror-scroll">
                {notifications.length === 0 ? (
