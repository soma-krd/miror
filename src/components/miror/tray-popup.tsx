    ...
    >
      ...
      <header className="flex h-11 shrink-0 items-center gap-2 border-b border-border bg-sidebar px-3">
        ...
        <div className="flex-1">
          <div className="text-sm font-semibold leading-none">Miror</div>
...
function NotificationsPanel({
  ...
  notifications: ReturnType<typeof useMiror.getState>["notifications"];
  onBack: () => void;
}) {
  return (
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 text-center">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        Add a project in the main Miror window to start managing its services.
      </p>
      <button
        onClick={onOpenMain}
