...
export function SystemTray() {
  const { services, notifications, activeProjectId, startAllInProject, stopAllInProject } = useMiror();
        ...
        <div className="w-72 rounded-lg border border-border bg-card/95 backdrop-blur shadow-xl">
          <div className="border-b border-border px-3 py-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold">Miror Tray</span>
              <button
