      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Configure Miror behavior, integrations, and keyboard shortcuts.
          </p>
        </div>
        <AlertDialog>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <SettingRow
            ...
            description="Restore previously running services when Miror starts."
          ...
          <SettingRow
            ...
            description="Keep Miror running in the menu bar when the window is closed."
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex rounded-lg bg-muted/50 p-0.5">
              <button
                ...
                className={`rounded-md px-3 py-1 text-xs font-medium transition-all miror-press ${
                  settings.theme === "dark"
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-xs text-muted-foreground">
          ...
          <p className="pt-2 text-[11px] italic">
            Miror runs a real Rust backend (tokio::process::Command + axum + SQLite)
